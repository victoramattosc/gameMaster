      ...
      return (
        <div className={styles.all}>
          ...
          <ul>
            {anotacao.map((jogador: any, index: any) => (
              <li key={index} className={styles.anotacao}>
                {jogador}
                <button onClick={() => removerAnotacao(index)} className={styles.botaotrash}><FiTrash2 color="red"/></button>
          ...
          <div className={styles.inputdiv}>
            ...
            />
            <button onClick={adicionarAnotacao} className={styles.botao}><FiPlusCircle color="#65b8a6" size={'20px'}/></button>
          </div>
          </div>
        </div>
      );
