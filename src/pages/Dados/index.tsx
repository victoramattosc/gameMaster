...
export function Dados() {
  ...
  const [jogar, setJogar]: any = useState(0); // Inicializado 0
  ...
  // Atualizar as funções de rolagem para receber o tipo de dado
  const somarTipo = (jogar: any) => {
    let total = 0;
    let text = "";
    ...
    <div>
      ...
      <div className={styles.main}>
        ...
        <div className={styles.row2}>
          <button onClick={() => botaoJogar(4)} className={styles.botaodado}>
            Lançar D4
          </button>
          <button onClick={() => botaoJogar(6)} className={styles.botaodado}>
            Lançar D6
          </button>
          <button onClick={() => botaoJogar(8)} className={styles.botaodado}>
            Lançar D8
          </button>
          <button onClick={() => botaoJogar(10)} className={styles.botaodado}>
            Lançar D10
          </button>
          <button onClick={() => botaoJogar(12)} className={styles.botaodado}>
            Lançar D12
          </button>
          <button onClick={() => botaoJogar(20)} className={styles.botaodado}>
            Lançar D20
          </button>
          <button onClick={() => botaoJogar(100)} className={styles.botaodado}>
            Lançar D100
          </button>
        </div>
